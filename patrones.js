window.patrones = [
  ...
  //4
  {
    ...
    descripcion: "Las personas con un Patrón Creativo muestran dos fuerzas opuestas en su comportamiento.   El deseo de resultados tangibles se contrapone a un impulso de igual magnitud por la perfección.  Su agresividad se templa con su sensibilidad.  La rapidez de pensamiento y tiempo de reacción se ven frenados por el deseo de explorar todas las soluciones posibles antes de tomar una decisión. Las personas creativas preveen de manera extraordinaria el enfoque que hay que dar a un proyecto y efectúan los cambios oportunos.  En vista de que las personas con un Patrón Creativo son perfeccionistas y cuentan con una gran habilidad para planear, los cambios que efectúan suelen ser apropiados, aunque  les pueda faltar atención a las relaciones interpersonales. La persona creativa desea libertad para explorar y la autoridad para examinar y verificar los resultados.  Puede tomar las decisiones diarias con rapidez,  pero puede ser extremadamente cauteloso al tomar decisiones de verdadera importancia.  “¿Debería aceptar este ascenso?”, “¿debería mudarme a otro sitio?”.   Por su necesidad de obtener resultados y perfección, la persona creativa no se preocupa mucho por las formas sociales.  Puede parecer fría, ajena y brusca."
  },
  //5
  {
  ...
  //7
  {
    ...
    descripcion: "El promotor cuenta con una extensa red de contactos que le proporciona una base activa para realizar sus negocios.  Gregario y sociable, le es fácil hacer amigos.  Rara vez se opone intencionalmente a alguien.  El promotor busca ambientes socialmente favorables donde pueda continuar desarrollando y conservando sus contactos.  Con su excelente capacidad de palabra, promueve muy bien sus propias ideas y genera entusiasmo hacia proyectos ajenos.  Gracias  a su amplia esfera de contactos, el Promotor tiene acceso a las personas apropiadas cuando necesita ayuda. En vista de que el promotor prefiere por naturaleza la interacción con otros y participa en actividades que implican contacto con gente, se interesa menos en la realización del trabajo.  Aunque su trabajo imponga actividades solitarias, seguirá buscando situaciones que impliquen reuniones y vida social activa.  Le agrada participar en reuniones, comités y conferencias. Por su optimismo natural, el Promotor tiende a sobreestimar la capacidad de los demás.  Suele llegar a conclusiones favorables sin haber considerado todos los hechos.  Con entrenamiento y dirección adecuados se puede ayudar al Promotor a desarrollar objetividad y a dar la importancia debida a los resultados.  Planear y controlar el tiempo le puede significar un reto.  Le conviene limitar el tiempo dedicado a conversar y de esta manera recordarse a sí mismo la urgencia de “concluir” y llevar a término una tarea."
  },
  //8
  {
  ...
  //12
  {
    ...
    descripcion: "El profesional valora la destreza en áreas especializadas.  Su enorme deseo de “destacar en algo”, lo lleva a un esmerado control de su propio desempeño en el trabajo.  Aunque su meta es ser “el” experto en un área determinada, el Profesional da la impresión de saber un poco de todo.  Esta imagen es más marcada cuando pone en palabras el conocimiento que posee sobre diversos temas. En su relación con otros, el Profesional suele proyectar un estilo relajado, diplomático y afable.  Esta actitud puede cambiar de súbito en su área de especialización cuando se concentra demasiado en alcanzar altos niveles de rendimiento.  Al valorar la autodisciplina, el Profesional evalúa a los demás sobre la base de su autodisciplina, la que mide por su rendimiento diario.  Sus expectativas en relación consigo mismo y con los demás son elevadas.  Suele exteriorizar su desilusión. Al mismo tiempo que su naturaleza le pide concentrarse en desarrollar una propuesta organizada del trabajo y en aumentar sus propias capacidades,   El Profesional necesita asimismo ayudar a otros a perfeccionar sus talentos.  Además, necesita saber apreciar mejor a quienes contribuyen en el esfuerzo del trabajo, aunque no usen lo que el Profesional considera el “método correcto”."
  },
  //13
  {
